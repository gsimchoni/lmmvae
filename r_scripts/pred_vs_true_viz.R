...
# Longitudinal simulation viz ---------------------------------------


B <- read_csv("data/data_for_viz/B_pred_longitudinal.csv")
U <- read_csv("data/data_for_viz/U_pred_longitudinal.csv")
X <- read_csv("data/data_for_viz/X_reconstructed_longitudinal.csv")
...
ggsave("images/sim_viz_longitudinal.png", p, device = "png", width = 16, height = 8, dpi = 300)


# Spatial simulation viz ---------------------------------------


B <- read_csv("data/data_for_viz/B_pred_spatial.csv")
U <- read_csv("data/data_for_viz/U_pred_spatial.csv")
X <- read_csv("data/data_for_viz/X_reconstructed_spatial.csv")
...
ggsave("images/sim_viz_spatial.png", p, device = "png", width = 16, height = 8, dpi = 300)
